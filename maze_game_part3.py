from pygame import *
mypath = 'C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/'
...
class Player(GameSprite):
    ...
    def fire(self):
        bullet = Bullet('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/bullet.png', self.rect.centerx, self.rect.bottom, 15, 20, 15)
        bullets.add(bullet)
...
class Enemy2(GameSprite):
    ...
    #movement of an enemy
    def update(self):
        if self.rect.y <= 540: #w1.wall_x + w1.wall_width
            self.side = "bottom"
...
# back = transform.scale(image.load('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/bullet.png'), (win_width, win_height))#setting the background picture
...
w3 = GameSprite('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/platform2_v.png', 500, 300, 50, 400)
w4 = GameSprite('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/platform2_v.png', 500, 100, 50, 200)
w5 = GameSprite('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/platform2.png', 0, 550, 400, 50)
w6 = GameSprite('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/platform2.png', 100, 400, 400, 0)
w7 = GameSprite('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/platform2.png', 0, 250, 400, 50)
w8 = GameSprite('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/platform2.png', 0, 100, 400, 50)
# w8 = GameSprite('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/platform2.png', 0, 100, 400, 50)
...
#creating sprites
packman = Player('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/hero.png', 5, win_height - 80, 80, 80, 0, 0)
final_sprite = GameSprite('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/pac-1.png', win_width - 85, win_height - 100, 80, 80)

monster1 = Enemy('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/cyborg.png', win_width - 80, 100, 80, 80, randint(15,30))
monster2 = Enemy('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/cyborg.png', win_width - 80, 180, 80, 80, randint(15,30))
monster3 = Enemy('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/cyborg.png', win_width - 70, 260, 80, 80, randint(15,30))
monster4 = Enemy('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/cyborg.png', win_width - 70, 340, 80, 80, randint(15,30))
monster5 = Enemy('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/cyborg.png', win_width - 70, 420, 80, 80, randint(15,30))
monster6 = Enemy('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/cyborg.png', win_width - 70, 500, 80, 80, randint(15,30))
...
while run:
    ...
    if not finish:
        ...
        if sprite.spritecollide(packman, monsters, False):
            finish = True
            #calculate the ratio
            img = image.load('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/game-over_1.png')
        ...
        if sprite.collide_rect(packman, final_sprite):
            finish = True
            img = image.load('C:/Data Scientist/Algonova/Courses/Python Pro I/Modul 6/L4/thumb.jpg')
